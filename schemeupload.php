...
$desig = strtoupper($_POST['code']);
$phone = $_POST['scheme'];
$intname = strtoupper($_POST['Semester']);
$bank = strtoupper($_POST['ccode']);
$acc = $_POST['cname'];
$ifsc = strtoupper($_POST['pr']);
$department = strtoupper($_POST['in']);

$sql = "INSERT INTO `scheme` VALUES('$name','$desig','$phone', '$intname', '$bank','$acc', '$ifsc','department');";
...
if(isset($_POST['dbbtn1'])){
  $file =  $_FILES['csvfile']['tmp_name'];
      ...
      while(($cont = fgetcsv($handle,1000,",")) !== false)
      {
            ...
            $query = "INSERT INTO `scheme` VALUES ('', '${cont['0']}', '${cont['1']}', '${cont['2']}', '${cont['3']}', '${cont['4']}', '${cont['5']}','${cont['6']}','${cont['7']}')";
